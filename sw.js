...
self.addEventListener("fetch", event => {
  ...
  event.respondWith((async()=>{
    ...
    const coreAsset=sameOrigin && /\/(?:app\.js|style\.css|ui-v200\.js|ui-v200\.css|airport-timezones\.js|fdp-rules\.js|roster-parser-utils\.js)$/.test(url.pathname);
