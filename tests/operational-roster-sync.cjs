...
const context=vm.createContext({console,Intl,Date,Map,tbody:body,fitEnabled:false,rosterTimeBasis:'LT',
...
rows([
 ...
 {date:'13-Sep-2026',dutyStart:'20:10',item:'MH6242',dep:'KUL 21:25',arr:'MAA 22:30',block:'0:00',duty:'11:25'},
 {date:'13-Sep-2026',item:'MH6243',dep:'MAA 00:30(+1)',block:'0:00'},
...
assert.equal(cell(1,'block'),'03:53 ACT');
run('resetOperationalRecord(duty)');
assert.equal(cell(2,'dep'),'MAA 00:30(+1)');
assert.equal(cell(3,'arr'),'KUL 06:50(+1)');
assert.equal(cell(1,'duty'),'11:25');
assert.equal(cell(1,'block'),'03:53 ACT');
...
storage.clear();rows([{date:'13-Sep-2026',dutyStart:'20:10',item:'MH6242',dep:'KUL 21:25',arr:'MAA 22:30',dutyEnd:'23:15',block:'0:00',duty:'05:35'}]);
...
console.log('PASS: screenshot times, sector advance, return/overnight, duty totals, standby isolation, saved-record reload, resets, single-sector compatibility');
